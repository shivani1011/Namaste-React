...
export const restaurantList = [
 ...
 // const searchText = "KFC"; // Javascript variable 
    // To make it work this is not recommend because it won't change itself, we wont able to modify or type anything inside the input feild.
    // To make it work we need to maintain a variable that changes itself whenever we type or modify anything so you need to maintain a varaible that is a react variable. React varaible are kind of state variables.
    // whenever create a local variable in react u need to use these state varaibles, those state variables are created using hooks.
    // useState() : function creates a state varaible
    // This function returns an array. The first element of array is your variable name.